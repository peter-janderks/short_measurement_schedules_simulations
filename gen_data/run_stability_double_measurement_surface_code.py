...
def get_normal_data(diameters, rounds, error_probabilities, measurement_noise_factor):
    samples_normal = sinter.collect(
        ...
        max_errors=1000,
        tasks=generate_SD6_tasks(diameters, rounds, error_probabilities, measurement_noise_factor),
        decoders=["pymatching"],
...
def main():
    ...
    for measurement_noise_factor in measurement_noise_factors:
        get_normal_data(diameters, rounds, error_probabilities, measurement_noise_factor)
