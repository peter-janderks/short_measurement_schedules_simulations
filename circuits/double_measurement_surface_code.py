...
#            print(ancilla_coords, ancilla_flags)
    ...
    def build_ancilla_detector(self, z_cor):
        for m_index, (q_coords, q_index) in enumerate(self.ancilla_qubit_dict.items()):
            ...
            if x_cor % 1 == 0:
                ...
                # ah this needs to go previous round!
    ...
    def measure_ancilla_qubits(self, z_cor, all_qubits):
        ...
        # flag_qubit_indexes = list(self.flag_qubit_dict.values())
        # self.builder.M(flag_qubit_indexes)

        # then measure ancilla qubits
