...
class RotatedSurfaceCode(object):
    def __init__(self, distance, p_idling, p_resonator_idling, p_1, p_2, p_m, p_prep, rounds=0):
        ...
        (self.data_qubits,
         ...
         self.builder.Z_bottom_boundary_ancilla) = self.create_t0()
    ...
    def create_t0(self):
        ...
        X_left_boundary_ancilla, X_right_boundary_ancilla, index = self.create_X_boundary(index)

        Z_top_boundary_ancilla, Z_bottom_boundary_ancilla, index = self.create_Z_boundary(index)
    ...
    def create_X_boundary(self, index):
        ...
        return (X_left_boundary_ancilla_qubits, X_right_boundary_ancilla_qubits, index)
    ...
    def create_Z_boundary(self, index):
        ...
        return (top_boundary_ancilla_qubits, bottom_boundary_ancilla_qubits, index)
